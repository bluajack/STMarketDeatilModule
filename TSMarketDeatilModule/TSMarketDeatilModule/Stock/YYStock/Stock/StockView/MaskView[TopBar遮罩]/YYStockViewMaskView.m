...
- (NSArray *)drawKlineTexts {
    return @[
             [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,[self.selectedModel.High floatValue]],
             [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,[self.selectedModel.Open floatValue]],
             [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,[self.selectedModel.Low floatValue]],
             [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,[self.selectedModel.Close floatValue]],
             ];
}

- (NSArray *)drawTimeLineTexts {
    return @[
             [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,[((id<YYStockTimeLineProtocol>)self.selectedModel).Price floatValue]],
             ...
             [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,((id<YYStockTimeLineProtocol>)self.selectedModel).AvgPrice],
             ];
}
@end
