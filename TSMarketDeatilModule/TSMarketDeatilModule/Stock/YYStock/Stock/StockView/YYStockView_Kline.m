...
- (void)drawLeftDesc {
    ...
    CGSize textSize = [self rectOfNSString:[NSString stringWithFormat:BKConStant.sharedInstance.accuracy,(maxValue + minValue)/2.f] attribute:attribute].size;
    ...
    //顶部间距
    for (int i = 0; i < 5; i++) {
        NSString *text = [NSString stringWithFormat:BKConStant.sharedInstance.accuracy,maxValue - unitValue * i];
    ...
    CGFloat kTextY = YYStockScrollViewTopGap + self.stockScrollView.frame.size.height * (1 - [YYStockVariable volumeViewRadio])+10;
    CGFloat wanshouY = YYStockScrollViewTopGap + 15 + self.stockScrollView.frame.size.height * (1 - [YYStockVariable volumeViewRadio]) +10 ;
...
- (void)drawTopDesc {
    ...
    NSDictionary *attribute = @{NSFontAttributeName:[UIFont systemFontOfSize:9],NSForegroundColorAttributeName:[UIColor YYStock_topBarNormalTextColor]};
    NSString *ma5Text = [NSString stringWithFormat:[NSString stringWithFormat:@"MA5 %@", BKConStant.sharedInstance.accuracy],[selectedModel MA5]];
    NSString *ma10Text = [NSString stringWithFormat:[NSString stringWithFormat:@"MA10 %@", BKConStant.sharedInstance.accuracy],[selectedModel MA10]];
    NSString *ma20Text = [NSString stringWithFormat:[NSString stringWithFormat:@"MA20 %@", BKConStant.sharedInstance.accuracy],[selectedModel MA20]];
