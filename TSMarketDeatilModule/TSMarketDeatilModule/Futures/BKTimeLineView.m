...
#import "ColorMacro.h"
#import "SBYAxis.h"
#import "SBAnimateView.h"
#import "NSTimer+LSBBlocksSupport.h"
#import "BKTimeOffsetView.h"
#import "UtilsMacro.h"
#import "NSDate+Category.h"

@interface BKTimeLineView (){
    ...
    BKTimeOffsetView *timeOffsetView;
...
@property (nonatomic, strong)SBYAxis *tm_YAxis; // y 轴
...
@property (nonatomic, strong)SBAnimateView *ltAniView;
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _ltAniView = [[SBAnimateView alloc] initWithFrame:CGRectMake(2.5, 0, 5, 5)];
        ...
        timeOffsetView = [[BKTimeOffsetView alloc] init];
